...
<body style="background-color: lavender">
  ...
  <form action="user_login_next.php">
  <input type="submit" class="submitbtn" name="back" value="⬅" style="background:#7F00FF;color:white;font-size:30px"/>
  </form>
 <table>
 <tr>
  <th><br>Id<br><br></th> 
  ...
  if ($result = mysqli_query($con, $sql))
   {
		...
		while($row = $result->fetch_assoc())
		{
			...
			"</td><td><br>". $row["phone"]. "<br></br></td><td><a href='foods1.html'><input type='submit' 
